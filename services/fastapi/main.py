...
from src.utils.pid_manager import PIDManager

log_manager = LogManager()
pid_manager = PIDManager()
log_file_path = log_manager.get_active_log_path("fastapi")
...
async def startup_event():
    ...
    try:
        ...
        pid_manager.create_pid_file(
            ...
            extra_info={
                "description": "Aeropon FastAPI Server",
                "version": "1.0.0"
            }
        )
...
async def shutdown_event():
    ...
    # Remove PID file
    try:
        pid_manager.remove_pid_file("fastapi")
    except Exception as e:
    ...
    try:
        ...
        # Archive log to backup
        log_manager.archive_log("fastapi")
    except Exception as e:
        print(f"⚠️  Error archiving log: {e}")
